<a href="path.php?path=2">
<div class="card bg-dark text-dark mt-3">
    <img class="card-img lazyload" src="media/covers/2.webp" alt="Card image">
...
<div class="card bg-dark text-dark mt-3">
    <img class="card-img lazyload" src="https://www.zuerich.com/sites/default/files/styles/768_576_focal_scale_crop/public/image/2020/web_zuerich_view_over_old_town_1920x1080_ZT_7967.jpg" alt="Card image">
    <div class="card-img-overlay d-flex flex-column p-2">
        <h2 class="card-title text-white">Downtown</h2>
        <p class="card-text text-white">This is a wider card with supporting text below as a natural lead-in to additional content.</p-->
        <!-- <p class="card-text text-white mt-auto"><img src="media/clock.png" style="height:23px;width:23px;padding:2px;">0.2 hours</p> >
    </div>
</div>
</a> -->